...
class DDOffsets:
    ...
    def __init__(self, game_base_address):
        ...
        self.GOLD_OFFSETS = [0x0, 0x230, 0x24, 0x98, 0x24, 0xBAC, 0x0] # gold pointer chain 
        self.BUSTS_OFFSETS = [0x0, 0x230, 0x24, 0x98, 0x24, 0xBAC, 0x48] #busts pointer chain
        self.PORTRAITS_OFFSETS = [0x0, 0x230, 0x24, 0x98, 0x24, 0xBAC, 0x90] #.. .. .. 
        self.DEEDS_OFFSETS = [0x0, 0x230, 0x24, 0x98, 0x24, 0xBAC, 0xD8]
        self.CRESTS_OFFSETS =[0x0, 0x230, 0x24, 0x98, 0x24, 0xBAC, 0x120]
        self.SHARDS_OFFSETS = [0x0, 0x230, 0x24, 0x98, 0x24, 0xBAC, 0x168]
